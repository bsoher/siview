# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.5 on Wed Dec 20 18:38:40 2023
#
...
class PanelSpectralUI(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        sizer_29.Add(label_8, 1, 0, 0)

        label_9 = wx.StaticText(self.PanelSpectralControls, wx.ID_ANY, "")
        sizer_29.Add(label_9, 1, 0, 0)

        self.ButtonProcessAll = wx.Button(self.PanelSpectralControls, wx.ID_ANY, "Process All")
        sizer_29.Add(self.ButtonProcessAll, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        self.Bind(wx.EVT_BUTTON, self.do_process_all, self.ButtonProcessAll)
    ...
    def do_process_all(self, event):  # wxGlade: PanelSpectralUI.<event_handler>
        print("Event handler 'do_process_all' not implemented!")
        event.Skip()
