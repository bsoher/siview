# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.5 on Wed Nov 29 22:55:30 2023
#
...
class ImagePaneUI(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.FloatStackFloor1 = wx.SpinCtrlDouble(self.window_1_pane_2, wx.ID_ANY, initial=0.0, min=0.0, max=100.0, style=wx.SP_ARROW_KEYS | wx.TE_PROCESS_ENTER)
        ...
        self.FloatStackCeil1 = wx.SpinCtrlDouble(self.window_1_pane_2, wx.ID_ANY, initial=0.0, min=0.0, max=100.0, style=wx.SP_ARROW_KEYS | wx.TE_PROCESS_ENTER)
        ...
        self.FloatStackFloor2 = wx.SpinCtrlDouble(self.window_1_pane_2, wx.ID_ANY, initial=0.0, min=0.0, max=100.0, style=wx.SP_ARROW_KEYS | wx.TE_PROCESS_ENTER)
        ...
        self.FloatStackCeil2 = wx.SpinCtrlDouble(self.window_1_pane_2, wx.ID_ANY, initial=0.0, min=0.0, max=100.0, style=wx.SP_ARROW_KEYS | wx.TE_PROCESS_ENTER)
        ...
        self.Bind(wx.EVT_SPINCTRLDOUBLE, self.on_calc_range1, self.FloatStackFloor1)
        self.Bind(wx.EVT_TEXT_ENTER, self.on_calc_range1, self.FloatStackFloor1)
        self.Bind(wx.EVT_SPINCTRLDOUBLE, self.on_calc_range1, self.FloatStackCeil1)
        self.Bind(wx.EVT_TEXT_ENTER, self.on_calc_range1, self.FloatStackCeil1)
        self.Bind(wx.EVT_BUTTON, self.on_calc_reset1, self.ButtonStackReset1)
        ...
        self.Bind(wx.EVT_SPINCTRLDOUBLE, self.on_calc_range2, self.FloatStackFloor2)
        self.Bind(wx.EVT_TEXT_ENTER, self.on_calc_range2, self.FloatStackFloor2)
        self.Bind(wx.EVT_SPINCTRLDOUBLE, self.on_calc_range2, self.FloatStackCeil2)
        self.Bind(wx.EVT_TEXT_ENTER, self.on_calc_range2, self.FloatStackCeil2)
        self.Bind(wx.EVT_BUTTON, self.on_calc_reset2, self.ButtonStackReset2)
        # end wxGlade
    ...
    def on_calc_range1(self, event):  # wxGlade: ImagePaneUI.<event_handler>
        print("Event handler 'on_calc_range1' not implemented!")
        event.Skip()

    def on_calc_reset1(self, event):  # wxGlade: ImagePaneUI.<event_handler>
        print("Event handler 'on_calc_reset1' not implemented!")
        event.Skip()
    ...
    def on_calc_range2(self, event):  # wxGlade: ImagePaneUI.<event_handler>
        print("Event handler 'on_calc_range2' not implemented!")
        event.Skip()

    def on_calc_reset2(self, event):  # wxGlade: ImagePaneUI.<event_handler>
        print("Event handler 'on_calc_reset2' not implemented!")
        event.Skip()
