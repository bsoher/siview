...
# Our modules
import siview.analysis.fileio.raw_reader as raw_reader
import siview.common.util.config as util_config
import siview.common.util.misc as util_misc
from siview.analysis.fileio.util_exceptions import IncompleteHeaderParametersError
from siview.common.mrs_data_raw import DataRaw, DataRawFidsum
from siview.common.constants import Deflate

# need for inline processing - no wx
try:
    import wx       # just a test here
    from siview.analysis.fileio.dicom_browser_dialog import PhilipsMrsBrowser
except:
...
class RawReaderDicomPhilips(raw_reader.RawReader):
    ...
    def pickfile(self, default_path=""):
        ...
        if not os.path.exists(default_path):
            default_path = util_config.SIViewConfig()["general"].get("last_dicom_browse_path", "")
