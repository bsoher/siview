...
# Our modules
from siview.analysis.block_prep_fidsum import BlockPrepFidsum
#from siview.analysis.block_prep_wbnaa import BlockPrepWbnaa
...
try:
    from siview.common.wx_gravy.common_dialogs import pickfile
except:
    pickfile = None
