# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.5 on Fri Oct 20 18:13:23 2023
#
...
class SiviewUI(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        grid_sizer_1.Add(self.SpinCalcFloor, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        grid_sizer_1.Add(self.SpinCalcCeil, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        self.Bind(wx.EVT_SPINCTRL, self.on_calc_range, self.SpinCalcFloor)
        self.Bind(wx.EVT_SPINCTRL, self.on_calcp_range, self.SpinCalcCeil)
    ...
    def on_calcp_range(self, event):  # wxGlade: SiviewUI.<event_handler>
        print("Event handler 'on_calcp_range' not implemented!")
        event.Skip()
