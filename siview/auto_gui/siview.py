# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.4 on Sun Jul 31 15:26:08 2022
#
...
class StudysetUI(wx.Panel):
    def __init__(self, *args, **kwds):
        # begin wxGlade: StudysetUI.__init__
        ...
        sizer_4 = wx.StaticBoxSizer(wx.StaticBox(self.TabImages, wx.ID_ANY, "Timeseries/Results Controls"), wx.VERTICAL)
    ...
    def on_splitter(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_splitter' not implemented!")
        event.Skip()

    def on_results(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_results' not implemented!")
        event.Skip()

    def on_map_range(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_map_range' not implemented!")
        event.Skip()

    def on_map_reset(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_map_reset' not implemented!")
        event.Skip()

    def on_time_range(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_time_range' not implemented!")
        event.Skip()

    def on_time_reset(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_time_reset' not implemented!")
        event.Skip()

    def on_time_course_model(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_time_course_model' not implemented!")
        event.Skip()

    def on_weight_function(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_weight_function' not implemented!")
        event.Skip()

    def on_peak_min(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_peak_min' not implemented!")
        event.Skip()

    def on_peak_start(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_peak_start' not implemented!")
        event.Skip()

    def on_peak_max(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_peak_max' not implemented!")
        event.Skip()

    def on_delay1_min(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_delay1_min' not implemented!")
        event.Skip()

    def on_delay1_start(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_delay1_start' not implemented!")
        event.Skip()

    def on_delay1_max(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_delay1_max' not implemented!")
        event.Skip()

    def on_delay2_min(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_delay2_min' not implemented!")
        event.Skip()

    def on_delay2_start(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_delay2_start' not implemented!")
        event.Skip()

    def on_delay2_max(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_delay2_max' not implemented!")
        event.Skip()

    def on_rate1_min(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_rate1_min' not implemented!")
        event.Skip()

    def on_rate1_start(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_rate1_start' not implemented!")
        event.Skip()

    def on_rate1_max(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_rate1_max' not implemented!")
        event.Skip()

    def on_rate2_min(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_rate2_min' not implemented!")
        event.Skip()

    def on_rate2_start(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_rate2_start' not implemented!")
        event.Skip()

    def on_rate2_max(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_rate2_max' not implemented!")
        event.Skip()

    def on_base_min(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_base_min' not implemented!")
        event.Skip()

    def on_base_start(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_base_start' not implemented!")
        event.Skip()

    def on_base_max(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_base_max' not implemented!")
        event.Skip()

    def on_chop(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_chop' not implemented!")
        event.Skip()

    def on_reset_mask(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_reset_mask' not implemented!")
        event.Skip()

    def on_fit_all(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_fit_all' not implemented!")
        event.Skip()

    def on_fit_slice(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_fit_slice' not implemented!")
        event.Skip()

    def on_fit_current(self, event):  # wxGlade: StudysetUI.<event_handler>
        print("Event handler 'on_fit_current' not implemented!")
        event.Skip()

# end of class StudysetUI
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.StudysetUI = StudysetUI(self, wx.ID_ANY)
        sizer_1.Add(self.StudysetUI, 1, wx.EXPAND, 0)
